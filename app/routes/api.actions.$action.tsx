...
export async function action({ request, params }: ActionFunctionArgs) {
  ...
  if (validation.data.action === "cooldown") {
    ...
    args.executeOnProtocol = true;
  } else if ((validation.data.action as any) === "unlike") {
    // backward compat for a data migration
    validation.data.action = "hideQuietly";
    args.executeOnProtocol = true;
  }
  ...
  if (validation.data.action === "like" || validation.data.action === "hideQuietly") {
...
export async function loader({ request, params }: LoaderFunctionArgs) {
  ...
  if (type === "grantRole") {
    ...
    actionDef = actions.find((a) => a.automodAction === "hideQuietly");
  } else {
