...
INSERT INTO "new_ModeratedChannel" ("active", "banThreshold", "createdAt", "excludeCohosts", "excludeUsernames", "id", "imageUrl", "updatedAt", "url", "userId") SELECT "active", "banThreshold", "createdAt", "excludeCohosts", coalesce("excludeUsernames", '[]') AS "excludeUsernames", "id", "imageUrl", "updatedAt", "url", "userId" FROM "ModeratedChannel";
