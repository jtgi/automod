/*
  ...
  - You are about to drop the column `userFid` on the `Seen` table. All the data in the column will be lost.
  - Added the required column `userId` to the `Seen` table without a default value. This is not possible if the table is not empty.
