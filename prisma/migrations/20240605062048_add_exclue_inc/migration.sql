/*
  ...
  - You are about to drop the column `likeToCurate` on the `ModeratedChannel` table. All the data in the column will be lost.
...
CREATE TABLE "new_ModeratedChannel" (
    ...
    "inclusionRules" TEXT NOT NULL DEFAULT '[]',
    "exclusionRules" TEXT NOT NULL DEFAULT '[]',
