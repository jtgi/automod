...
INSERT INTO "new_Role" ("channelId", "createdAt", "description", "id", "isEveryoneRole", "name", "permissions", "updatedAt") SELECT "channelId", "createdAt", "description", "id", "isEveryoneRole", "name", "permissions", "updatedAt" FROM "Role";
DROP TABLE "Role";
