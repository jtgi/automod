/*
  ...
  - Added the required column `ownerId` to the `Usage` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_Usage" (
    ...
    CONSTRAINT "Usage_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
